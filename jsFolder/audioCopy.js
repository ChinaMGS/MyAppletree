...
//点击上一曲
$('.js-prev').on('touchend',{audio: _$audio, arr : currentArr},Audio.prevSong)

//点击下一曲
$('.js-next').on('touchend',{audio: _$audio, arr : currentArr},Audio.nextSong);
